...
<html>
    ...
    <body>
        ...
        <main class="main">
            <h1>Registrati per acquistare gli energy drink più mostruosi del pianeta</h1>
            <form name='signup' method='post' enctype="multipart/form-data" autocomplete="off">
                ...
                <div class="allow"> 
                    ...
                    <label for='allow'>Accetto i termini e condizioni d'uso di Monster Energy.</label>
                </div>
                <?php if(isset($error)) {
